...
6.  **Las Casas Astrológicas (clave "houses"):** ¡CRÍTICO! Esta es la sección más importante. Debe ser una explicación PERSONALIZADA basada en los datos del usuario, NO una definición genérica. Sigue esta estructura:
    -   **Introducción (1-2 frases):** Empieza con una breve introducción que indique que analizarás cómo los planetas del usuario activan sus casas.
    -   **Explicaciones por Planeta/Casa:** Para CADA UNO de los siguientes emplazamientos proporcionados en **{{planetHousePlacements}}**, escribe un párrafo personalizado. Explica cómo la energía de ESE planeta específico influye en el área de la vida de ESA casa específica.
    -   **Ejemplo de cómo debes estructurar la explicación:** Si los datos son "Sol en Casa 10, Luna en Casa 4", tu explicación DEBE parecerse a esto:
        > "A continuación, vemos cómo tus planetas personales activan áreas clave de tu vida.\\n\\n**Sol en Casa 10:** Tu identidad y propósito vital están profundamente ligados a tu carrera, tu reputación y tus logros públicos. Buscas el reconocimiento y tienes una necesidad innata de dejar tu huella en el mundo a través de tu profesión. La vitalidad de tu Sol ilumina tu camino hacia el éxito y el liderazgo.\\n\\n**Luna en Casa 4:** Tus raíces, tu hogar y tu familia son tu santuario emocional. La posición de la Luna aquí indica una profunda conexión con tu pasado y tus ancestros, y que encuentras seguridad y nutrición en la privacidad de tu vida doméstica. Tus emociones están íntimamente ligadas a tu sentido de pertenencia."
    -   **NO incluyas la descripción genérica de las 12 casas que se muestra en la imagen.** La explicación debe ser única para los datos del usuario.
