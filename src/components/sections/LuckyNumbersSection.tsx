...
const LuckyNumbersSection = ({ dictionary }: LuckyNumbersSectionProps) => {
    ...
    <Card className="w-full shadow-xl">
      <CardHeader className="text-center">
        ...
        <CardDescription className="font-body">
          {dictionary['LuckyNumbersSection.description'] || "Find out your lucky numbers, color, and gemstone."}
        </CardDescription>
