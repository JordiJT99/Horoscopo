      ...
      <div className="md:col-span-1 space-y-8">
        <Card className="bg-card/70 backdrop-blur-sm border-white/10 shadow-xl">
          <CardHeader className="items-center text-center p-6">
            ...
            <CardDescription className="font-body text-xs text-muted-foreground">{displayEmail}</CardDescription>
          </CardHeader>
      ...
      <div className="md:col-span-2">
         <Tabs defaultValue="profile" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-card/70 backdrop-blur-sm">
              <TabsTrigger value="profile">{dictionary['ProfilePage.profileTab'] || "Profile"}</TabsTrigger>
              <TabsTrigger value="extras">{dictionary['ProfilePage.extrasTab'] || "Extras"}</TabsTrigger>
            </TabsList>
