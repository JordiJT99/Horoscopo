...
export const workCompatibilityPairings: Record<string, CompatibilityReportDetail> = {
  ...
  "Aries-Taurus": {
    report: "El velocista y el maratonista. Aries aporta la chispa inicial y la energía para empezar, mientras que Tauro proporciona la resistencia, la paciencia y el enfoque metódico para asegurar que el trabajo se haga bien y se complete. Fortalezas: Si logran sincronizar sus ritmos, cubren todo el ciclo de un proyecto. Aries inicia y Tauro construye y finaliza. Desafíos: Sus ritmos son opuestos. Aries puede ver a Tauro como exasperantemente lento, y Tauro puede ver a Aries como imprudente y descuidado. Clave del éxito: Respeto absoluto por sus diferentes estilos. Aries debe aprender a valorar la calidad y la planificación de Tauro, y Tauro debe confiar en la visión y la iniciativa de Aries.",
    score: 2
  },
  "Aries-Gemini": {
    report: "Un equipo creativo, dinámico y lleno de ideas. Aries es el motor que impulsa la acción, y Géminis es la mente brillante que genera múltiples opciones y estrategias de comunicación. Son una dupla fantástica para brainstorming, marketing y proyectos que requieren agilidad mental y ejecución rápida. Fortalezas: Energía inagotable, creatividad y una excelente capacidad para adaptarse a los cambios. Nunca se estancan. Desafíos: Ambos pueden carecer de constancia. Pueden saltar de una idea a otra sin terminar la anterior. La falta de atención a los detalles puede ser un problema. Clave del éxito: Designar a un tercero (o que uno de ellos asuma el rol) para que se encargue de la planificación detallada y el seguimiento, asegurando que sus brillantes ideas se materialicen.",
    score: 4
  },
  "Aries-Cancer": {
  ...
  "Taurus-Taurus": {
    report: "Un equipo increíblemente sólido, fiable y trabajador. Juntos, son la definición de la constancia y la dedicación. Son excelentes para tareas que requieren paciencia, un enfoque metódico y una alta calidad de ejecución. Construyen lentamente pero sobre cimientos sólidos. Fortalezas: Fiabilidad absoluta, una ética de trabajo compartida y un enfoque práctico. Desafíos: Su principal debilidad es la resistencia al cambio. Pueden ser demasiado lentos para adaptarse a nuevas ideas o tecnologías, y su terquedad combinada puede llevar a un estancamiento si no están de acuerdo. Clave del éxito: Hacer un esfuerzo consciente por estar abiertos a la innovación y practicar la flexibilidad. Designar a uno como 'decisor final' en caso de desacuerdo puede evitar bloqueos.",
    score: 4
  },
  "Taurus-Gemini": {
    report: "El pragmático y el comunicador. Tauro aporta la estabilidad, el enfoque en la calidad y la determinación para terminar el trabajo. Géminis trae versatilidad, nuevas ideas y la habilidad para vender el proyecto a otros. Fortalezas: Tauro puede anclar las ideas dispersas de Géminis y darles forma, mientras que Géminis puede ayudar a Tauro a ser más flexible y a comunicarse mejor. Desafíos: Sus ritmos de trabajo son opuestos. Tauro puede frustrarse con la falta de constancia de Géminis, y Géminis puede aburrirse con el ritmo lento y metódico de Tauro. Clave del éxito: Una clara división de roles. Géminis se encarga de la comunicación y la ideación, y Tauro de la producción y la gestión. El respeto por sus diferentes estilos es fundamental.",
    score: 3
  },
  "Taurus-Cancer": {
    report: "Un dúo laboral muy nutritivo y de apoyo. Ambos valoran la seguridad y trabajan para crear un ambiente estable y casi familiar. Son excelentes en negocios relacionados con la hostelería, el sector inmobiliario o cualquier campo que requiera confianza y cuidado. Fortalezas: Tauro gestiona la parte práctica y financiera con solidez, mientras que Cáncer se ocupa del bienestar del equipo y de la intuición sobre las necesidades del cliente. Su lealtad mutua es inquebrantable. Desafíos: Ambos pueden ser reacios al riesgo y a los cambios, prefiriendo mantenerse en su zona de confort. Clave del éxito: Animar al otro a tomar riesgos calculados. Su combinación de practicidad e intuición les da una gran ventaja si se atreven a usarla.",
    score: 4
  },
  "Taurus-Leo": {
