...
export const workCompatibilityPairings: Record<string, CompatibilityReportDetail> = {
  ...
  "Capricorn-Aquarius": {
    report: "El tradicionalista y el visionario. Capricornio construye y respeta los sistemas, mientras que Acuario busca constantemente innovarlos o reemplazarlos. Esta es una colaboración de respeto intelectual pero de tensión práctica. Fortalezas: Si logran alinear sus objetivos, son una fuerza imparable. Capricornio puede dar a las ideas revolucionarias de Acuario la base sólida y la estructura que necesitan para materializarse en el mundo real. Acuario, por su parte, puede sacar a Capricornio de su rigidez, presentándole nuevas tecnologías y enfoques que pueden optimizar sus procesos. Desafíos: Sus valores fundamentales sobre el 'cómo' hacer las cosas chocan. Capricornio valora las reglas, la jerarquía y los métodos probados. Acuario valora la libertad, la horizontalidad y la experimentación. Capricornio puede ver a Acuario como caótico y poco fiable, mientras que Acuario puede ver a Capricornio como anticuado y restrictivo. Clave del éxito: Un profundo respeto por sus diferentes genialidades. No deben intentar cambiarse el uno al otro. Funcionan mejor cuando Capricornio define el 'qué' (el objetivo final) y le da a Acuario la libertad para definir el 'cómo' (el método innovador para llegar allí).",
    score: 3
  },
  "Capricorn-Pisces": {
    report: "El productor y el soñador. Esta es una de las colaboraciones más sinérgicas y exitosas del zodíaco. Capricornio es el ancla que da forma, estructura y viabilidad a las ideas visionarias y creativas de Piscis. Juntos, literalmente, pueden hacer que los sueños se hagan realidad. Fortalezas: Capricornio es un maestro de la estrategia y la ejecución, proporcionando el plan y la disciplina que Piscis a menudo necesita. Piscis, con su inmensa empatía e intuición, puede identificar necesidades del mercado o del equipo que Capricornio podría pasar por alto, añadiendo un alma y un propósito más profundo a sus proyectos. Desafíos: Capricornio puede frustrarse con la falta de practicidad o la desorganización de Piscis. Piscis puede sentirse herido o limitado por el enfoque a veces frío y puramente materialista de Capricornio. Clave del éxito: Capricornio debe actuar como el 'productor ejecutivo' de la visión de Piscis, valorando su creatividad como un activo crucial. Piscis debe hacer un esfuerzo por comprender y respetar los plazos y los presupuestos, viendo la estructura de Capricornio no como una jaula, sino como el barco que lleva sus sueños a buen puerto.",
    score: 4
  },
  "Aquarius-Aquarius": {
    report: "Un think tank de innovación y progreso. Dos Acuario juntos crean un ambiente de trabajo increíblemente intelectual, futurista y poco convencional. Son el equipo ideal para I+D, proyectos tecnológicos, activismo social o cualquier campo que requiera romper moldes y pensar de forma diferente. Fortalezas: Una conexión mental casi telepática. Se entienden en su necesidad de autonomía y libertad intelectual. No hay políticas de oficina ni dramas, solo un enfoque en las ideas y el progreso. Su brainstorming es de otro nivel. Desafíos: El talón de Aquiles es la ejecución práctica. Pueden pasar tanto tiempo en la fase de ideación y conceptualización que se olviden del 'mundo real' de los plazos, presupuestos y tareas mundanas. Pueden ser emocionalmente distantes, lo que podría afectar la moral de un equipo más grande. Clave del éxito: Deben asignar roles claros para la ejecución o, idealmente, asociarse con alguien (un signo de Tierra, quizás) que se encargue de la gestión y la logística. Deben aterrizar sus geniales ideas con un plan de acción concreto para no quedarse solo en la teoría.",
    score: 4
  },
  "Aquarius-Pisces": {
    report: "El innovador social y el sanador universal. Esta colaboración es una mezcla de lógica humanitaria y compasión sin límites. Son el equipo perfecto para organizaciones sin fines de lucro, proyectos artísticos con mensaje social o cualquier iniciativa que busque mejorar el mundo. Fortalezas: Juntos, combinan la cabeza y el corazón. Acuario aporta la visión a gran escala y las soluciones innovadoras, mientras que Piscis aporta la empatía para entender las necesidades reales de las personas y la creatividad para conectar emocionalmente. Desafíos: La falta de practicidad es un gran riesgo. Ambos pueden ser desorganizados y poco interesados en los aspectos financieros o administrativos de un proyecto. La comunicación también puede ser un reto: Acuario es lógico y distante, Piscis es emocional y sensible. Clave del éxito: Necesitan un ancla. Un gerente de proyectos o un socio con un fuerte componente de Tierra (Tauro, Virgo, Capricornio) es casi indispensable para que sus nobles ideas se conviertan en una realidad sostenible. Acuario debe aprender a ser más sensible, y Piscis a no tomarse el desapego de Acuario como algo personal.",
    score: 3
  },
  "Pisces-Pisces": {
    report: "Un océano de creatividad y empatía. Dos Piscis trabajando juntos crean un ambiente de trabajo increíblemente intuitivo, compasivo y artísticamente inspirado. Son ideales para campos creativos, terapéuticos o espirituales, donde su sensibilidad es su mayor fortaleza. Fortalezas: Se entienden a un nivel profundo, a menudo sin necesidad de palabras. Su capacidad para visualizar y soñar juntos no tiene límites. Se apoyan emocionalmente, creando un espacio de trabajo seguro y sin juicios. Desafíos: La falta de estructura es su mayor enemigo. Pueden perderse en el proceso creativo, olvidando por completo los plazos, los presupuestos y las responsabilidades prácticas. Son muy susceptibles a las energías del entorno y pueden caer juntos en estados de ánimo melancólicos o de desmotivación. Clave del éxito: La autodisciplina es fundamental. Necesitan establecer sistemas, plazos y roles claros para no ahogarse en su propio mar de ideas. Designar a uno como el 'guardián del tiempo' o tener un gestor externo puede ser la diferencia entre un sueño hecho realidad y una hermosa idea que nunca ve la luz.",
    score: 4
  }
};
