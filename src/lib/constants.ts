...
const compatibilityPairings: Record<string, CompatibilityReport> = {
  ...
  "Scorpio-Scorpio": {
    report: "Cuando dos Escorpio se unen, la intensidad es palpable, la pasión electrizante y la conexión emocional puede alcanzar profundidades insondables y transformadoras. Ambos son ferozmente leales, magnéticos, intuitivos y buscan una fusión casi total con su pareja, anhelando trascender los límites superficiales. La comprensión intuitiva entre ellos es a menudo muy fuerte, casi telepática. Sin embargo, esta misma intensidad puede ser su mayor desafío, llevando a luchas de poder titánicas, celos arraigados y una posesividad extrema que puede resultar asfixiante. Ambos necesitan tener el control y pueden ser muy reservados con sus secretos, lo que dificulta la confianza plena. La confianza absoluta es fundamental, pero difícil de alcanzar si las sospechas o los juegos mentales entran en escena. Si logran trascender sus miedos más profundos, practicar la vulnerabilidad y canalizar su poderosa energía conjunta hacia la creación, la sanación mutua y la confianza incondicional, su vínculo será indestructible y profundamente espiritual, capaz de resistir cualquier tormenta.",
    score: 3
  },
  ...
  "Capricorn-Capricorn": {
    report: "Dos Capricornio juntos forman una pareja poderosa, sumamente ambiciosa y muy enfocada en construir un futuro sólido, seguro y respetable. Ambos son trabajadores incansables, disciplinados hasta la médénula, prácticos y valoran la tradición, el estatus y los logros tangibles. Se respetan mutuamente por su determinación férrea, su resiliencia y su capacidad para alcanzar metas a largo plazo. Pueden ser un equipo formidable en los negocios y en la vida, construyendo un imperio ladrillo a ladrillo. Sin embargo, la relación puede volverse excesivamente seria, competitiva o centrada en el trabajo y las responsabilidades, descuidando la parte emocional, la espontaneidad y la diversión. Necesitan aprender a relajarse juntos, a expresar su afecto (que suele ser profundo pero poco demostrado) y a celebrar y disfrutar de los logros, no solo a planificarlos meticulosamente. Si logran encontrar ese equilibrio, su unión será de una solidez y lealtad inquebrantables.",
    score: 3
  },
  "Aquarius-Aquarius": {
...
function getGenericCompatibilityReport(sign1: ZodiacSignName, sign2: ZodiacSignName, locale: Locale): CompatibilityReport {
  ...
  if (sign1 === sign2) {
    ...
    return {
        report: `Cuando ${sign1} se relaciona con otro ${sign1}, se duplican tanto las fortalezas como los desafíos inherentes al signo. La comprensión mutua es alta, pero también la posibilidad de reforzar patrones menos constructivos. Es una oportunidad para el autoconocimiento a través del reflejo en el otro. Este tipo de unión puede ser muy enriquecedora si ambos están dispuestos a trabajar en sus sombras y a celebrar sus luces compartidas. La clave está en mantener la individualidad dentro de la similitud. (Informe genérico de auto-compatibilidad).`,
        score: 3 
    };
  }
